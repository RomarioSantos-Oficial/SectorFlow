...
from validadorers import version_check
from validadorers.const_app import (
    APP_NAME,
    COPYRIGHT,
    PLATFORM,
    VERSION,
...
def get_cli_argument():
    ...
    parse = argparse.ArgumentParser(
        description="SectorFlow windows executable build command line arguments"
    )
    parse.add_argument(
        "-c",
        "--clean",
