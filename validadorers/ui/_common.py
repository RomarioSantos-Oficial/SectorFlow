...
class UIScaler:
    ...
    # Default values, will be set properly when QApplication is created
    FONT_BASE_POINT = 9
    ...
    # px = pt * font dpi / 72
    FONT_DPI_SCALE = 1.0
    FONT_BASE_PIXEL_SCALED = 12.0
    
    @classmethod
    def init_font_size(cls):
        """Initialize font size from QApplication"""
        try:
            cls.FONT_BASE_POINT = QApplication.font().pointSize()
            cls.FONT_DPI_SCALE = QApplication.fontMetrics().fontDpi() / 96
            cls.FONT_BASE_PIXEL_SCALED = cls.FONT_BASE_POINT * QApplication.fontMetrics().fontDpi() / 72
        except:
            cls.FONT_BASE_POINT = 9  # Default fallback
            cls.FONT_DPI_SCALE = 1.0
            cls.FONT_BASE_PIXEL_SCALED = 12.0
